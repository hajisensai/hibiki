...
- Source: Hibiki Balanced pack + RECOMMENDED_FINAL_SELECTION.zh-CN.txt
- Surfaces: 84
- Generated image choices: 252
- Sections: Entry 3, Pages 53, Shared/support 28
- Explicit surface picks imported: 30
...
| `popup_main.dart` | B | [image](interface-images/popup-main-B.svg) | explicit surface pick | 03 Dictionary | 16 Empty, loading, error states |
| `floating_dict_main.dart` | B | [image](interface-images/floating-dict-main-B.svg) | explicit surface pick | 03 Dictionary | 18 Component system |
...
| Surface | Choice | Selected image | Source | Primary board | Support board |
| --- | --- | --- | --- | --- | --- |
| `anki_settings_page.dart` | C | [image](interface-images/anki-settings-page-C.svg) | explicit surface pick | 07 Creator and Anki | 05 Settings |
| `audio_recorder_page.dart` | C | [image](interface-images/audio-recorder-page-C.svg) | explicit surface pick | 07 Creator and Anki | 12 Media and sentence dialogs |
...
| `crop_image_dialog_page.dart` | C | [image](interface-images/crop-image-dialog-page-C.svg) | explicit surface pick | 07 Creator and Anki | 12 Media and sentence dialogs |
...
| `debug_log_page.dart` | A | [image](interface-images/debug-log-page-A.svg) | explicit surface pick | 15 Logs and debug | 09 System and debug |
...
| `dictionary_dialog_import_page.dart` | C | [image](interface-images/dictionary-dialog-import-page-C.svg) | explicit surface pick | 10 Dictionary management | 06 Import and modals |
| `dictionary_dialog_page.dart` | C | [image](interface-images/dictionary-dialog-page-C.svg) | explicit surface pick | 10 Dictionary management | 03 Dictionary |
...
| `dictionary_popup_layer.dart` | B | [image](interface-images/dictionary-popup-layer-B.svg) | explicit surface pick | 03 Dictionary | 04 Hoshi reader |
...
| `dictionary_popup_webview.dart` | B | [image](interface-images/dictionary-popup-webview-B.svg) | explicit surface pick | 03 Dictionary | 04 Hoshi reader |
| `dictionary_progress_dialog_content.dart` | C | [image](interface-images/dictionary-progress-dialog-content-C.svg) | explicit surface pick | 10 Dictionary management | 16 Empty, loading, error states |
| `dictionary_result_page.dart` | B | [image](interface-images/dictionary-result-page-B.svg) | explicit surface pick | 03 Dictionary | 12 Media and sentence dialogs |
| `dictionary_settings_dialog_page.dart` | C | [image](interface-images/dictionary-settings-dialog-page-C.svg) | explicit surface pick | 10 Dictionary management | 05 Settings |
...
| `display_settings_page.dart` | B | [image](interface-images/display-settings-page-B.svg) | explicit surface pick | 11 Reader customization | 04 Hoshi reader |
| `error_log_page.dart` | A | [image](interface-images/error-log-page-A.svg) | explicit surface pick | 15 Logs and debug | 16 Empty, loading, error states |
...
| `home_dictionary_page.dart` | B | [image](interface-images/home-dictionary-page-B.svg) | explicit surface pick | 03 Dictionary | 01 Home and navigation |
| `home_page.dart` | C | [image](interface-images/home-page-C.svg) | explicit surface pick | 01 Home and navigation | 05 Settings |
| `home_reader_page.dart` | C | [image](interface-images/home-reader-page-C.svg) | explicit surface pick | 01 Home and navigation | 02 Reader shelf |
...
| `lyrics_dialog_page.dart` | B | [image](interface-images/lyrics-dialog-page-B.svg) | explicit surface pick | 04 Hoshi reader | 12 Media and sentence dialogs |
...
| `reader_hoshi_history_page.dart` | A | [image](interface-images/reader-hoshi-history-page-A.svg) | explicit surface pick | 02 Reader shelf | 13 Tags and filters |
| `reader_hoshi_page.dart` | B | [image](interface-images/reader-hoshi-page-B.svg) | explicit surface pick | 04 Hoshi reader | 11 Reader customization |
...
| `tag_filter_sheet.dart` | C | [image](interface-images/tag-filter-sheet-C.svg) | explicit surface pick | 13 Tags and filters | 02 Reader shelf |
| `tag_management_page.dart` | C | [image](interface-images/tag-management-page-C.svg) | explicit surface pick | 13 Tags and filters | 05 Settings |
| `tag_picker_page.dart` | C | [image](interface-images/tag-picker-page-C.svg) | explicit surface pick | 13 Tags and filters | 06 Import and modals |
| `text_segmentation_dialog_page.dart` | C | [image](interface-images/text-segmentation-dialog-page-C.svg) | explicit surface pick | 07 Creator and Anki | 12 Media and sentence dialogs |
...
| `audiobook_play_bar.dart` | B | [image](interface-images/audiobook-play-bar-B.svg) | explicit surface pick | 04 Hoshi reader | 18 Component system |
...
| `hibiki_bottom_sheet.dart` | C | [image](interface-images/hibiki-bottom-sheet-C.svg) | explicit surface pick | 18 Component system | 06 Import and modals |
...
| `hibiki_icon_button.dart` | C | [image](interface-images/hibiki-icon-button-C.svg) | explicit surface pick | 18 Component system | 01 Home and navigation |
| `hibiki_list_tile.dart` | C | [image](interface-images/hibiki-list-tile-C.svg) | explicit surface pick | 18 Component system | 05 Settings |
...
| `hibiki_placeholder_message.dart` | A | [image](interface-images/hibiki-placeholder-message-A.svg) | explicit surface pick | 16 Empty, loading, error states | 18 Component system |
...
- 推荐基准：Hibiki Balanced。
- 阅读器、词典、词典管理、Anki/制卡、标签、日志和共享组件是高风险界面，先显式列出来方便逐项审。
- 未列出的界面继承 Hibiki Balanced 的 board 默认选择；如果比较页里改了例外，把对应行加到这里再生成最终规格。
- 这不是用户最终确认；最终实现前必须由用户确认 Pack 和例外。
