...
- Source: manifest defaults; user choices pending
- Surfaces: 84
- Generated image choices: 252
- Sections: Entry 3, Pages 53, Shared/support 28
- Explicit surface picks imported: 0
- Board-level picks imported: 0
- Draft status: defaults only; waiting for user choices
...
| --- | --- | --- | --- | --- | --- |
| `main.dart` | C | [image](interface-images/main-C.svg) | default | 01 Home and navigation | 16 Empty, loading, error states |
| `popup_main.dart` | B | [image](interface-images/popup-main-B.svg) | default | 03 Dictionary | 16 Empty, loading, error states |
| `floating_dict_main.dart` | B | [image](interface-images/floating-dict-main-B.svg) | default | 03 Dictionary | 18 Component system |
...
| Surface | Choice | Selected image | Source | Primary board | Support board |
| --- | --- | --- | --- | --- | --- |
| `anki_settings_page.dart` | C | [image](interface-images/anki-settings-page-C.svg) | default | 07 Creator and Anki | 05 Settings |
| `audio_recorder_page.dart` | C | [image](interface-images/audio-recorder-page-C.svg) | default | 07 Creator and Anki | 12 Media and sentence dialogs |
| `blur_options_dialog_page.dart` | B | [image](interface-images/blur-options-dialog-page-B.svg) | default | 11 Reader customization | 06 Import and modals |
| `book_css_editor_page.dart` | B | [image](interface-images/book-css-editor-page-B.svg) | default | 11 Reader customization | 04 Hoshi reader |
| `collections_page.dart` | A | [image](interface-images/collections-page-A.svg) | default | 08 Collections and stats | 12 Media and sentence dialogs |
| `crop_image_dialog_page.dart` | C | [image](interface-images/crop-image-dialog-page-C.svg) | default | 07 Creator and Anki | 12 Media and sentence dialogs |
| `custom_fonts_page.dart` | B | [image](interface-images/custom-fonts-page-B.svg) | default | 11 Reader customization | 05 Settings |
| `custom_theme_page.dart` | B | [image](interface-images/custom-theme-page-B.svg) | default | 11 Reader customization | 05 Settings |
| `debug_log_page.dart` | A | [image](interface-images/debug-log-page-A.svg) | default | 15 Logs and debug | 09 System and debug |
| `dictionary_dialog_delete_page.dart` | C | [image](interface-images/dictionary-dialog-delete-page-C.svg) | default | 10 Dictionary management | 06 Import and modals |
| `dictionary_dialog_import_page.dart` | C | [image](interface-images/dictionary-dialog-import-page-C.svg) | default | 10 Dictionary management | 06 Import and modals |
| `dictionary_dialog_page.dart` | C | [image](interface-images/dictionary-dialog-page-C.svg) | default | 10 Dictionary management | 03 Dictionary |
| `dictionary_entry_page.dart` | B | [image](interface-images/dictionary-entry-page-B.svg) | default | 03 Dictionary | 10 Dictionary management |
| `dictionary_page_mixin.dart` | B | [image](interface-images/dictionary-page-mixin-B.svg) | default | 03 Dictionary | 04 Hoshi reader |
| `dictionary_popup_layer.dart` | B | [image](interface-images/dictionary-popup-layer-B.svg) | default | 03 Dictionary | 04 Hoshi reader |
| `dictionary_popup_native.dart` | B | [image](interface-images/dictionary-popup-native-B.svg) | default | 03 Dictionary | 04 Hoshi reader |
| `dictionary_popup_webview.dart` | B | [image](interface-images/dictionary-popup-webview-B.svg) | default | 03 Dictionary | 04 Hoshi reader |
| `dictionary_progress_dialog_content.dart` | C | [image](interface-images/dictionary-progress-dialog-content-C.svg) | default | 10 Dictionary management | 16 Empty, loading, error states |
| `dictionary_result_page.dart` | B | [image](interface-images/dictionary-result-page-B.svg) | default | 03 Dictionary | 12 Media and sentence dialogs |
| `dictionary_settings_dialog_page.dart` | C | [image](interface-images/dictionary-settings-dialog-page-C.svg) | default | 10 Dictionary management | 05 Settings |
| `dictionary_structured_content_page.dart` | B | [image](interface-images/dictionary-structured-content-page-B.svg) | default | 03 Dictionary | 10 Dictionary management |
| `dictionary_term_page.dart` | B | [image](interface-images/dictionary-term-page-B.svg) | default | 03 Dictionary | 07 Creator and Anki |
| `dictionary_webview_media.dart` | B | [image](interface-images/dictionary-webview-media-B.svg) | default | 03 Dictionary | 10 Dictionary management |
| `display_settings_page.dart` | B | [image](interface-images/display-settings-page-B.svg) | default | 11 Reader customization | 04 Hoshi reader |
| `error_log_page.dart` | A | [image](interface-images/error-log-page-A.svg) | default | 15 Logs and debug | 16 Empty, loading, error states |
| `example_sentences_dialog_page.dart` | A | [image](interface-images/example-sentences-dialog-page-A.svg) | default | 12 Media and sentence dialogs | 03 Dictionary |
| `floating_dict_page.dart` | B | [image](interface-images/floating-dict-page-B.svg) | default | 03 Dictionary | 14 Profile, language, system |
| `history_reader_page.dart` | A | [image](interface-images/history-reader-page-A.svg) | default | 02 Reader shelf | 13 Tags and filters |
| `home_dictionary_page.dart` | B | [image](interface-images/home-dictionary-page-B.svg) | default | 03 Dictionary | 01 Home and navigation |
| `home_page.dart` | C | [image](interface-images/home-page-C.svg) | default | 01 Home and navigation | 05 Settings |
| `home_reader_page.dart` | C | [image](interface-images/home-reader-page-C.svg) | default | 01 Home and navigation | 02 Reader shelf |
| `hoshi_settings_page.dart` | B | [image](interface-images/hoshi-settings-page-B.svg) | default | 05 Settings | 11 Reader customization |
| `illustrations_viewer_page.dart` | A | [image](interface-images/illustrations-viewer-page-A.svg) | default | 08 Collections and stats | 12 Media and sentence dialogs |
| `language_dialog_page.dart` | A | [image](interface-images/language-dialog-page-A.svg) | default | 14 Profile, language, system | 06 Import and modals |
| `loading_page.dart` | A | [image](interface-images/loading-page-A.svg) | default | 16 Empty, loading, error states | 01 Home and navigation |
| `lyrics_dialog_page.dart` | B | [image](interface-images/lyrics-dialog-page-B.svg) | default | 04 Hoshi reader | 12 Media and sentence dialogs |
| `media_item_dialog_page.dart` | A | [image](interface-images/media-item-dialog-page-A.svg) | default | 12 Media and sentence dialogs | 08 Collections and stats |
| `media_item_edit_dialog_page.dart` | A | [image](interface-images/media-item-edit-dialog-page-A.svg) | default | 12 Media and sentence dialogs | 07 Creator and Anki |
| `media_source_picker_dialog_page.dart` | A | [image](interface-images/media-source-picker-dialog-page-A.svg) | default | 12 Media and sentence dialogs | 06 Import and modals |
| `miscellaneous_settings_page.dart` | A | [image](interface-images/miscellaneous-settings-page-A.svg) | default | 14 Profile, language, system | 05 Settings |
| `open_stash_dialog_page.dart` | A | [image](interface-images/open-stash-dialog-page-A.svg) | default | 12 Media and sentence dialogs | 07 Creator and Anki |
| `placeholder_source_page.dart` | A | [image](interface-images/placeholder-source-page-A.svg) | default | 16 Empty, loading, error states | 04 Hoshi reader |
| `popup_dictionary_page.dart` | B | [image](interface-images/popup-dictionary-page-B.svg) | default | 03 Dictionary | 14 Profile, language, system |
| `profile_management_page.dart` | A | [image](interface-images/profile-management-page-A.svg) | default | 14 Profile, language, system | 05 Settings |
| `reader_hoshi_history_page.dart` | A | [image](interface-images/reader-hoshi-history-page-A.svg) | default | 02 Reader shelf | 13 Tags and filters |
| `reader_hoshi_page.dart` | B | [image](interface-images/reader-hoshi-page-B.svg) | default | 04 Hoshi reader | 11 Reader customization |
| `reading_statistics_page.dart` | A | [image](interface-images/reading-statistics-page-A.svg) | default | 08 Collections and stats | 16 Empty, loading, error states |
| `switch_settings_page.dart` | B | [image](interface-images/switch-settings-page-B.svg) | default | 05 Settings | 14 Profile, language, system |
| `tag_filter_sheet.dart` | C | [image](interface-images/tag-filter-sheet-C.svg) | default | 13 Tags and filters | 02 Reader shelf |
| `tag_management_page.dart` | C | [image](interface-images/tag-management-page-C.svg) | default | 13 Tags and filters | 05 Settings |
| `tag_picker_page.dart` | C | [image](interface-images/tag-picker-page-C.svg) | default | 13 Tags and filters | 06 Import and modals |
| `text_segmentation_dialog_page.dart` | C | [image](interface-images/text-segmentation-dialog-page-C.svg) | default | 07 Creator and Anki | 12 Media and sentence dialogs |
| `websocket_dialog_page.dart` | A | [image](interface-images/websocket-dialog-page-A.svg) | default | 14 Profile, language, system | 15 Logs and debug |
...
| Surface | Choice | Selected image | Source | Primary board | Support board |
| --- | --- | --- | --- | --- | --- |
| `app_model.dart` | C | [image](interface-images/app-model-C.svg) | default | 18 Component system | 14 Profile, language, system |
| `base_history_page.dart` | A | [image](interface-images/base-history-page-A.svg) | default | 02 Reader shelf | 16 Empty, loading, error states |
| `base_media_search_bar.dart` | C | [image](interface-images/base-media-search-bar-C.svg) | default | 18 Component system | 03 Dictionary |
| `base_page.dart` | C | [image](interface-images/base-page-C.svg) | default | 18 Component system | 16 Empty, loading, error states |
| `base_source_page.dart` | C | [image](interface-images/base-source-page-C.svg) | default | 18 Component system | 03 Dictionary |
| `base_tab_page.dart` | C | [image](interface-images/base-tab-page-C.svg) | default | 18 Component system | 01 Home and navigation |
| `audiobook_import_dialog.dart` | A | [image](interface-images/audiobook-import-dialog-A.svg) | default | 06 Import and modals | 18 Component system |
| `audiobook_play_bar.dart` | B | [image](interface-images/audiobook-play-bar-B.svg) | default | 04 Hoshi reader | 18 Component system |
...
| `update_checker.dart` | A | [image](interface-images/update-checker-A.svg) | default | 14 Profile, language, system | 15 Logs and debug |
| `blur_options.dart` | B | [image](interface-images/blur-options-B.svg) | default | 11 Reader customization | 18 Component system |
