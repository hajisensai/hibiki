...
- The generated [interface image pack](interface-images/index.html) mirrors this table as 252 standalone SVG choices plus [manifest.json](interface-images/manifest.json), can step through the review queue, can jump to `Next unpicked`, can filter to `Only unpicked`, and can copy a full `Interface image picks` result.
...
| `hibiki_bottom_sheet.dart` | [18](18-component-system.svg) | [06](06-import-and-modals.svg) | C |  |
| `hibiki_divider.dart` | [18](18-component-system.svg) | [05](05-settings.svg) | C |  |
| `hibiki_dropdown.dart` | [18](18-component-system.svg) | [05](05-settings.svg) | C |  |
| `hibiki_icon_button.dart` | [18](18-component-system.svg) | [01](01-home-navigation.svg) | C |  |
| `hibiki_list_tile.dart` | [18](18-component-system.svg) | [05](05-settings.svg) | C |  |
| `hibiki_marquee.dart` | [18](18-component-system.svg) | [12](12-media-and-sentences.svg) | C |  |
| `hibiki_placeholder_message.dart` | [16](16-empty-loading-error-states.svg) | [18](18-component-system.svg) | A |  |
| `hibiki_popup_position.dart` | [18](18-component-system.svg) | [03](03-dictionary.svg) | C |  |
| `hibiki_search_history.dart` | [18](18-component-system.svg) | [03](03-dictionary.svg) | C |  |
| `hibiki_selectable_text.dart` | [18](18-component-system.svg) | [03](03-dictionary.svg) | C |  |
| `hibiki_tag.dart` | [13](13-tags-and-filters.svg) | [18](18-component-system.svg) | C |  |
| `hibiki_text_selection_controls.dart` | [18](18-component-system.svg) | [03](03-dictionary.svg) | C |  |
