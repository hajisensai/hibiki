...
| BUG | 修复 | 测试 | 标题 |
|---|:--:|:--:|---|
| [BUG-484](bugs/BUG-484-macos-data-root-restart-sandbox-crash.md) | ✅ | ✅ | macOS 数据迁移后自动重启崩溃 |
| [BUG-483](bugs/BUG-483-dictionary-download-catalog-stale.md) | ✅ | ✅ | 推荐词典下载链接失效 |
| [BUG-482](bugs/BUG-482-settings-log-count-stale.md) | ✅ | ✅ | 清除日志后系统页计数不刷新 |
