...
| [BUG-300](bugs/BUG-300-pgs-subtitle-delay.md) | ✅ | ✅ | 字幕同步滑条对 PGS/图形内封字幕无效（从不调 mpv sub-delay）(TODO-402 档①) |
| [BUG-300](bugs/BUG-300-video-next-cue-current.md) | ✅ | ✅ | 视频「下一句」跳到当前句（应排除当前句） |
