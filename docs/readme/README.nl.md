...
Flutter 3.44.0 heeft de v1 embedding API (`PluginRegistry.Registrar`) volledig verwijderd. De volgende plugins vereisen het verwijderen van gerelateerde verwijzingen:
