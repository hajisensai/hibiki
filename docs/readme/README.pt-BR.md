...
O Flutter 3.44.0 removeu completamente a API de embedding v1 (`PluginRegistry.Registrar`). Os seguintes plugins requerem a remoção das referências correspondentes:
