...
void main() {
  ...
  testWidgets('列出全部 4 个 Anime4K 预设', (WidgetTester tester) async {
    ...
    // 没有任何文件下载 → 没有 check 标记，全是下载图标。
    expect(find.byIcon(Icons.check), findsNothing);
    expect(find.byIcon(Icons.download_outlined),
        findsNWidgets(kAnime4kPresets.length));
  });
