...
/// 源码守卫（TODO-388）：屏幕左 / 右浮动 rail 按钮吃「界面大小」+「主题」，与其它控件一致。
///
...
/// 背景 / 图标走 [_videoChromeColorScheme]（cs.surface / cs.onSurface），与侧边锁按钮同源。
void main() {
  final File page =
  ...
  test('rail 背景 / 图标走主题色（不再硬编码黑白）', () {
    ...
    expect(body.contains('color: cs.onSurface'), isTrue,
        reason: 'rail 图标应用主题 onSurface');
