...
/// Asserts the post-migration DB is on the unified v20 shape: user_version=20,
/// epub_books name-PK with [expectedBooks] rows preserved, video_books keyed by
/// book_uid (no legacy id), and end-to-end usable.
