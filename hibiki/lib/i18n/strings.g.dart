...
class _StringsZhCn implements _StringsEn {
	...
	@override String get srt_import => '导入字幕书';
	@override String get srt_import_pick_srt => '选择字幕文件';
	...
	@override String get srt_import_success => '字幕书导入成功';
...
extension on _StringsZhCn {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'srt_import': return '导入字幕书';
			case 'srt_import_pick_srt': return '选择字幕文件';
			...
			case 'srt_import_success': return '字幕书导入成功';
