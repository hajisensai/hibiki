...
class _HibikiSelectableTextSelectionGestureDetectorBuilder
    extends TextSelectionGestureDetectorBuilder {
  _HibikiSelectableTextSelectionGestureDetectorBuilder({
    required _HibikiSelectableTextState state,
  })  : _state = state,
        super(delegate: state);

  final _HibikiSelectableTextState _state;
...
/// A class to handle text selection programmatically for the [HibikiSelectableText]
/// widget.
class HibikiSelectableTextController {
  ...
  ///
  /// Notice that [HibikiSelectableText.onSelectionChanged] won't be called.
...
///
/// The [HibikiSelectableText] widget displays a string of text with a single style.
...
/// {@end-tool}
///
/// Using the [HibikiSelectableText.rich] constructor, the [HibikiSelectableText] widget can
...
///
/// ```dart
/// const HibikiSelectableText.rich(
///   TextSpan(
...
/// ## Interactivity
///
/// To make [HibikiSelectableText] react to touch events, use callback [onTap] to achieve
...
class HibikiSelectableText extends StatefulWidget {
  ...
  final HibikiSelectableTextController? controller;
...
class _HibikiSelectableTextState extends State<HibikiSelectableText>
  ...
  late _HibikiSelectableTextSelectionGestureDetectorBuilder
  ...
  @override
  void didUpdateWidget(HibikiSelectableText oldWidget) {
