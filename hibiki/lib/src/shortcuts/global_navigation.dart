...
/// gamepad navigation:
///
/// * Escape pops the current full-page route (always installed — desktop is
///   where hardware Escape matters, and it is harmless elsewhere).
/// * The gamepad B button triggers a global back/dismiss. [enableGamepad] gates
///   this mapping: it is mobile-only (Android/iOS), since desktop embedders
///   never deliver gameButton* logical keys.
