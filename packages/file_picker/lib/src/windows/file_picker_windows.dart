...
class FilePickerWindows extends FilePicker {
  ...
  String fileTypeToFileFilter(FileType type, List<String>? allowedExtensions) {
    switch (type) {
      ...
      case FileType.audio:
        return 'Audios (*.mp3,*.m4a,*.m4b,*.aac,*.ogg,*.opus,*.flac,*.wav,*.wma,*.ac3,*.eac3,*.mp4,*.aiff,*.ape,*.tta,*.wv,*.mka,*.caf,*.midi)\x00*.mp3;*.m4a;*.m4b;*.aac;*.ogg;*.opus;*.flac;*.wav;*.wma;*.ac3;*.eac3;*.mp4;*.aiff;*.ape;*.tta;*.wv;*.mka;*.caf;*.midi\x00All Files (*.*)\x00*.*\x00\x00';
      case FileType.custom:
        return 'Files (*.${allowedExtensions!.join(',*.')})\x00*.${allowedExtensions.join(';*.')}\x00All Files (*.*)\x00*.*\x00\x00';
      case FileType.image:
        return 'Images (*.bmp,*.gif,*.jpeg,*.jpg,*.png)\x00*.bmp;*.gif;*.jpeg;*.jpg;*.png\x00All Files (*.*)\x00*.*\x00\x00';
      case FileType.media:
        return 'Videos (*.avi,*.flv,*.mkv,*.mov,*.mp4,*.mpeg,*.webm,*.wmv)\x00*.avi;*.flv;*.mkv;*.mov;*.mp4;*.mpeg;*.webm;*.wmv\x00Images (*.bmp,*.gif,*.jpeg,*.jpg,*.png)\x00*.bmp;*.gif;*.jpeg;*.jpg;*.png\x00All Files (*.*)\x00*.*\x00\x00';
      case FileType.video:
        return 'Videos (*.avi,*.flv,*.mkv,*.mov,*.mp4,*.mpeg,*.webm,*.wmv)\x00*.avi;*.flv;*.mkv;*.mov;*.mp4;*.mpeg;*.webm;*.wmv\x00All Files (*.*)\x00*.*\x00\x00';
    }
  }
